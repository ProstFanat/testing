...
public class TripBoard extends BasePage {
    ...
    //////////////////////////////////////
    @FindBy(xpath = "//datatable-row-wrapper[1]//*[contains(@class, 'datatable-body-cell')][8]//a")
    ...
    public boolean filterBy(String value, String filterBy){
        ...
        for(int i = 1; i <= getTableSize(); i++){
            ...
            if(isElementDisplayedByPath("//datatable-row-wrapper[" + i + "]//*[contains(@class, 'datatable-body-cell')][10]//" + aOrSpan)) {
                if (by == 9) {
                    if ((value).equals(driver.findElement(By.xpath("//datatable-row-wrapper[" + i + "]//*[contains(@class, 'datatable-body-cell')][9]//" + aOrSpan)).getText())) {
                        counter++;
                    }
                }
            }
...
//        System.out.println(counterTable);
    ...
    // Найти кнопку сортировки таблицы
    @FindBy(xpath = "//*[text() = 'Trip #']")
    public WebElement filterTableTrip;
