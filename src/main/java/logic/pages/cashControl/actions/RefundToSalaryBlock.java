...
public class RefundToSalaryBlock extends ActionsMenu {
    @FindBy(xpath = "//refund-to-salary/descendant::label[contains(text(),'Driver')]/following-sibling::ng-select")
    ...
    @FindBy(css = "textarea[placeholder='Additional Information for Refund Accounting...']")
