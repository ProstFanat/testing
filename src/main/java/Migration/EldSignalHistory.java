...
public class EldSignalHistory extends RecordMapperValueObject {
    ...
    public String distanceSinceEngineStart;
    public String engineHours;
    public String engineRuntime;
    public String voltage;
    public String stateCode;
    public String eldDeviceName;
    public String eldDeviceSerial;
    public String eldDeviceVersion;
    public Long dataProviderId;
    public Long truckDeviceSignalHistoryId;
