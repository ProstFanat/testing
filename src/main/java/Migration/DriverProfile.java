...
public class DriverProfile extends RecordMapperValueObject {
    ...
    public Long lcKey;
    public Character voidStamp;
    public java.sql.Date hiredDate;
    public java.sql.Date termDate;
    public String loginName;
    public String password;
    public String phone;
    public String homeTerminalTimezone;
    public Character eldExempt;
    public String licenseNumber;
    public String licenseState;
    public Character isFleetManager;
    public Integer eldMultidayBasisUsed;
    public Integer eldMultidayBasisUsedCan;
    public Integer eld24HourPeriodStartingTime;
    public Character eldIsYardMoveAllowed;
    public Character eldIsPersonalUseAllowed;
    public Integer eldSignalFrequency;
    public Character onTrip;
    public Character eldConfigurationChanged;
    public String eldExemptComment;
    public String eldEditMode;
    public String eldAppMode;
    public Date eldEventsLock;
    public String xRef; //for link from dispatch mate, contains short user name, example 'SHVETSOV'
    public String fastCardNumber;
    public Long HOSProviderId;
    public Character forAudit;
    public String gender;
    public Date birthDate;
    public Long citizenshipCountryId;
    public String countryName;
    public Character ownerOperator;
    public Long truckId;
    public Long trailerId;
    public Long ACLUserId;
    public Character useDriverAddressForHOS = 'N';
    public String addressForHOS;
    public Character eventEditingIsPermitted = 'Y';
    public Character sendPt30ErrorLog = 'N';
    public Integer tripStartMinSpeed;
    public Integer tripEndMaxSpeed;
    public Character regainHoursAtMidnight = 'N';
    public Character displayTimeOnMobileGraph = 'Y';
    public Character disable15Days = 'N';
    public Character allowEditInformation = 'N';
    public Character allowDeleteEvents = 'Y';
    public Character allowInsertEvents = 'Y';
    public Character allowEditEvents = 'Y';
    public Character allowDrivingEvents = 'Y';
    public Character dataRestriction = 'N';
    public Character lockForChange = 'N';
    public Character collectGPSWithoutTruck = 'N';
    public String autoSetToOnDuty;
    public String generateLocationDescription = "Manual";
    public Date editsOutOfSync;
    public Date inspectionReportOutOfSync;
    public Date daySummaryOutOfSync;
    public Date borderOutOfSync;
    public Long lastTripId;
    public String legalFirstName;
    public String legalLastName;
    public Character muteViolationSounds = 'N';
    public Date hiredDateAsDate;
    public Date termDateAsDate;
    public String photo;
    public Date started;
    ...
    public String preferredDistanceUnit;
    public Character hasSetPreferredDistanceUnit = 'N';
    public String graphClockDisplay = "24-hour";
    public String fullName;
    public String opentextPassword;
    public Date lastLoginDateTime;
    public Character showAlertOnNewMessage = 'N';
    public Character soundNotificationOnNewMessage = 'N';
    public Character enableVoiceMessage = 'N';
    public String fileName;
    public String pin;
    public Long subscriptionId;
    public String deviceSequenceOutOfSync;
    public Date startInspection;
    public Long dispatchingSystemId;
    public Long amountOfHosVerifiedDays;
    public String email;
    public Character isDriverContractorWithPersonalAuthority = 'N';
    public String companyName;
    public String companyAddress;
    public String yardAddress;
    public String contactInfo;
    public String authorityNumbers;
    public Character eldEventsSyncRequested = 'N';
    public Character eldEventsAutoSync = 'Y';
    public Date updateDate;
    public Character onlyUsaDriving = 'N';
    public Integer appVersionMsgIntervalMin;
    public Character csvSetMilesAndHoursZeroForManualEvents;
    public Integer maxPersonalUseDistance;
    public Integer maxPersonalUseDuration;
    public Character violator = 'N';
    public String violatorComment;
    public String mobileAppOptions;
    public Long masterDBRefId;
    public Long clientDBRefId;
    public String organizationName;
    public Character sendLoadOffers = 'Y';
    //public String eldType = "teeld";
